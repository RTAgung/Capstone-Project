...
import com.example.moviecatalogue.core.data.source.local.room.MovieDatabase
...
val databaseModule = module {
    ...
    single {
        val passphrase: ByteArray = SQLiteDatabase.getBytes("moviepassphrase".toCharArray())
